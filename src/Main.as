package 
{
	...
	public class Main extends Engine 
	{
		...
		override public function update():void
		{
			...
			if (Input.check(Key.LEFT)) FP.camera.x -= CAMERA_SPEED * FP.elapsed;
			if (Input.check(Key.RIGHT)) FP.camera.x += CAMERA_SPEED * FP.elapsed;
			if (Input.check(Key.UP)) FP.camera.y -= CAMERA_SPEED * FP.elapsed;
			if (Input.check(Key.DOWN)) FP.camera.y += CAMERA_SPEED * FP.elapsed;
